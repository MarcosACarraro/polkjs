var ctrProfissional = (function () {
    ...
    var _create = function () {
        ...
        _confirmDeleteProfissional.create("mainContainer", "Profissional");
    }
    ...
    function createMainContainer() {
        ...
        _filterHeaderTitle.innerHTML = "<span class='glyphicon glyphicon-th-list'></span><span>&nbsp;Profissional</span>";
        ...
        _iconFilter.setAttribute("onclick", "javascript:ctrProfissional.toggleFilter();")
    ...
    function createBottom() {
        ...
        _btnNew.setAttribute("onclick", "javascript:ctrProfissional.newItem();")
    ...
    function _search(nomeProfissional) {
        $.ajax({
            async: true,
            cache: false,
            url: "http://localhost:3412/profissional",
            type: "GET",
            data: {
